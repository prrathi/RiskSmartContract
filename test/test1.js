...
contract("NewPlatform", (accounts) => {
  it("new platform", async () => {
    ...
    var play = await NewPlatform.play.call(tokenName);
    console.log(play);
    ...
    // await platform1.openTrade(2, 102, {from: accounts[3]});
    // var trade = await platform1.trades.call(0);
    // await tether._mint(accounts[5], 100);
    // var investorName3 = keccak256("investor3");
    // await platform1.executeTrade(1, 0, participantName2, {from: accounts[5]});
